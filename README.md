...
| Responsive Web Design | Clone the website, [The Next Web](http://smashingmagazine.com/) Figure out the different screen break points, and use **responsive web desing** principles to recreate the website presentation. | [Go to repo](https://github.com/mosesogwo/thenextweb-clone) | To be added |
